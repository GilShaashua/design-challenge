        ...
        <section className="clients-container full main-layout">
            ...
            >
                <path
                    fillRule="evenodd"
                    clipRule="evenodd"
                    d="M100 100C155.228 100 200 55.2285 200 0C200 -55.2285 155.228 -100 100 -100C44.7715 -100 0 -55.2285 0 0C0 55.2285 44.7715 100 100 100ZM100 33C118.225 33 133 18.2254 133 0C133 -18.2254 118.225 -33 100 -33C81.7746 -33 67 -18.2254 67 0C67 18.2254 81.7746 33 100 33Z"
                    fill="#014E56"
                />
                <path
                    fillRule="evenodd"
