...
export function AppFooter() {
    return (
        <footer className="app-footer full main-layout">
            ...
            <div className="footer-inner-container-tablet flex align-center space-between">
                <div className="logo-nav-icons-container flex column space-between">
                ...
                <div className="location-reserved flex column space-between">
                    <div className="location-details">
                        <p>987 Hillcrest Lane</p>
                        <p>Irvine, CA</p>
                        <p>California 92714</p>
            ...
            <div className="footer-inner-container-mobile flex column align-center">
                <div className="logo-nav-container flex column space-between">
                    <div className="logo-nav">
                        <div className="logo">
                            <h1>myteam</h1>
                        </div>
                ...
                <div className="location flex column space-between">
                    <div className="location-details">
                        <p>987 Hillcrest Lane</p>
                        <p>Irvine, CA</p>
                        <p>California 92714</p>
                ...
                <div className="icons-reserved flex column align-center">
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="104"
                        height="24"
